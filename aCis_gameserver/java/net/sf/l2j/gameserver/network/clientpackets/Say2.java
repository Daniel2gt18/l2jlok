...
public final class Say2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			player.sendMessage("General chat is available from " + Config.CHAT_ALL_LEVEL + " level.");
		...
		{
			player.sendMessage("Private chat is available from " + Config.CHAT_TELL_LEVEL + " level.");
			player.sendPacket(ActionFailed.STATIC_PACKET);
			return;
		}
		...
		{
			player.sendMessage("Shout chat is available from " + Config.CHAT_SHOUT_LEVEL + " level.");
			player.sendPacket(ActionFailed.STATIC_PACKET);
			return;
		}
		...
		{
			player.sendMessage("Trade chat is available from " + Config.CHAT_TRADE_LEVEL + " level.");
			player.sendPacket(ActionFailed.STATIC_PACKET);
			return;
		}
