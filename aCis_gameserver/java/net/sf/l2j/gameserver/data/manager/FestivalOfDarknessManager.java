...
public class FestivalOfDarknessManager
{
	...
	private class L2DarknessFestival
	{
		...
		protected void spawnFestivalMonsters(int respawnDelay, int spawnType)
		{
			...
			{
				case 0, 1 -> npcSpawns = (_cabal == CabalType.DAWN) ? FESTIVAL_DAWN_PRIMARY_SPAWNS[_levelRange] : FESTIVAL_DUSK_PRIMARY_SPAWNS[_levelRange];
				case 2 -> npcSpawns = (_cabal == CabalType.DAWN) ? FESTIVAL_DAWN_SECONDARY_SPAWNS[_levelRange] : FESTIVAL_DUSK_SECONDARY_SPAWNS[_levelRange];
				case 3 -> npcSpawns = (_cabal == CabalType.DAWN) ? FESTIVAL_DAWN_CHEST_SPAWNS[_levelRange] : FESTIVAL_DUSK_CHEST_SPAWNS[_levelRange];
				default -> new int[0][0];
			};
